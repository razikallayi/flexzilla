...
<link rel="stylesheet" href="{{url('project/ar/css/bootstrap.min.css')}}" type="text/css">
<link rel="stylesheet" href="{{url('project/ar/css/stylesheet.css')}}" type="text/css">
...
<div class="page-header">
  <div class="container">
     <div class="col-md-12 no-padding">
        ...
        <div class="menu">
          <ul>
            <li><a href="{{url('ar/')}}">Home</a></li>
            <li><a href="{{url('ar/about')}}">About</a></li>
            <li><a href="{{url('ar/contact')}}">Contact</a></li>
          </ul>
        </div>
...
<nav class="navbar navbar-default bootsnav">
    <div class="container">  
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{url('ar/')}}"><img src="{{url('project/images/flex-logo.png')}}" class="logo" alt=""></a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
            ...
            @foreach($Categories->all() as $category)
               <li><a href="{{url('ar/category/'.$category->slug)}}">{{$category->name}}</a></li>
            @endforeach
           {{--      <li><a href="{{url('products')}}">Muscle Building</a></li>
                <li><a href="{{url('products')}}">Pre Workout</a></li>
                <li><a href="{{url('products')}}">Health & Wellness</a></li>
                <li><a href="{{url('products')}}">Fat Burner</a></li>
                <li><a href="{{url('products')}}">Snacks & more</a></li>
           ...
           <div class="ie clearfix">
             <div class="col-md-6 no-padding">
                ...
                <ul>
                  ...
                  <li><a href="{{url('ar/brands')}}">Brands</a></li>
                  <li><a href="{{url('ar/terms')}}">Terms & Conditions</a></li>
                  <li><a href="{{url('ar/privacy')}}">Privacy policy</a></li>
