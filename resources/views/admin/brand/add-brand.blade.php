						...
						<div class="col-sm-12">
							<div class="form-group">
								...
								<div id="result" class="img-preview preview-lg row">
									...
									<div id="image-preview-{{substr($imageName,0,-4)}}" class="col-lg-3 col-md-4 col-sm-6 m-t-30" style="min-height:100px"><span><img class="img-responsive" src="{{url(App\Models\Brand::IMAGE_LOCATION)."/".$imageName}}"></span></div>
									@endforeach
									@endif
								</div>
							</div>
