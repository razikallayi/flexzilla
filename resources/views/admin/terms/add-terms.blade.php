...
<div class="row">
	...
	<div class="row clearfix">
						...
						<div class="col-md-6 col-sm-12">
							...
							<div class="form-group ">
								<div class="form-line">
									<input type="text" value="{{old('title_ar')}}" name="title_ar" class="form-control arabic_input">
								</div>
							</div>
						</div>
						...
						<div class="col-md-6 col-sm-12">
							...
							<div class="form-group">
								<div class="form-line">
									<textarea rows="10" name="content_ar" class="form-control arabic_input" >{{old('content_ar')}}</textarea>
								</div>
							</div>
						</div>
